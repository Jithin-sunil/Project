    ...
    <div class="container">
        ...
        <form id="form1" name="form1" method="post" action="">
            <table>
                <tr>
                    <td colspan="2">
                        <img src="../Assets/File/User/Photo/<?php echo $data['seller_photo']; ?>" width="150px" height="160px" alt="User Photo" />
                    </td>
                </tr>
                <tr>
                    <td>Name:</td>
