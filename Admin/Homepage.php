...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="SellerVerification.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Seller Verification</a>
                    <a href="ViewComplaint.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>View Complaints</a>
    ...
    <script src="../Assets/Template/Admin/ib/easing/easing.min.js"></script>
