                            ...
                            <div class="card-deck">
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-img-secondary">
                                        <h6  class="text-light bg-info text-center rounded p-1"><?php echo $rowS["mobile_name"]; ?></h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <?php
											...
											$query = "SELECT * FROM tbl_review where mobiledetails_id = '".$rowS["mobiledetails_id"]."' ORDER BY review_id DESC";
								 	...
								 	$stocka = "select sum(cart_quantity) as stock from tbl_cart where product_id = '" . $rowS["mobile_id"] . "'";
                                     ...
                                     <?php
                                               ...
                                               if ($stock > 0) {
                                    ?>
                                         <a href="javascript:void(0)" onclick="addCart('<?php echo $rowS["mobiledetails_id"]; ?>')" class="btn btn-success btn-block">Add to Cart</a> 
                                        <?php
                                 } else if ($stock == 0) {
                                         ?>
