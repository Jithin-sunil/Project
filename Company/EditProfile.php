...
<form id="form1" name="form1" method="post" action="">
  <table width="423" height="437" border="1">
   ...
   <tr>
      ...
      <input type="text" name="txtname" id="txtname" value="<?php echo $data['company_name']?>" required/></td>
    </tr>
    <tr>
      <td height="46">Email</td>
      <td><label for="txtemail"></label>
      <input type="text" name="txtemail" id="txtemail" value="<?php echo $data['company_email']?>" /></td> 
    </tr>
     <tr>
      <td height="46">Contact</td>
      <td><label for="txtcontact"></label>
        <label for="txtcontact"></label>
      <input type="text" name="txtcontact" id="txtcontact"  value="<?php echo $data['company_contact']?>" /></td>
    </tr>
   <tr>
      <td height="60">Address</td>
      <td><label for="txtaddress"></label>
      <textarea name="txtaddress" id="txtaddress" cols="45" rows="5" value="" ><?php echo $data['company_address']?></textarea></td>
    </tr>
    <tr> 
