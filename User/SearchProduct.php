<?php
ob_start();
//include("../Assets/AjaxPages/Head.php");
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="text-center">
                        <img src="../Assets/Assets/Template/Search/loader.gif" id='loder' width="200" style="display: none"/>
                    </div>
...
<?php
//include("../Assets/AjaxPages/Foot.php");
ob_flush();
?>
</html>