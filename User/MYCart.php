...
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            $sel = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id where b.user_id='" .$_SESSION["userid"]. "' and booking_status='0' and cart_status=0";
            $res = $con->query($sel);
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/File/Product/<?php echo $rowpr["product_photo"] ?>"
                        />
                </div>
